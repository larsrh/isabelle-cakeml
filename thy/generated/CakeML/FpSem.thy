...
\<comment> \<open>\<open>val fp64_mul_add : rounding -> word64 -> word64 -> word64 -> word64\<close>\<close>
...
definition fpfma  :: " 64 word \<Rightarrow> 64 word \<Rightarrow> 64 word \<Rightarrow> 64 word "  where 
     " fpfma v1 v2 v3 = ( fp64_mul_add To_nearest v2 v3 v1 )" 
  for  v1  :: " 64 word " 
  and  v2  :: " 64 word " 
  and  v3  :: " 64 word "


\<comment> \<open>\<open>val fp_top : fp_top -> word64 -> word64 -> word64 -> word64\<close>\<close>
fun fp_top  :: " fp_top_op \<Rightarrow> 64 word \<Rightarrow> 64 word \<Rightarrow> 64 word \<Rightarrow> 64 word "  where 
     " fp_top FP_Fma = ( fpfma )"
