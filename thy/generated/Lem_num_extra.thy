...
definition integerOfChar  :: " char \<Rightarrow> int "  where 
     " integerOfChar = ( \<lambda>x .  
  (case  x of
        (CHR ''0'') =>( 0 :: int)
    | (CHR ''1'') =>( 1 :: int)
    | (CHR ''2'') =>( 2 :: int)
...
fun  integerOfStringHelper  :: "(char)list \<Rightarrow> int "  where 
     " integerOfStringHelper (d # ds) = ( integerOfChar d + (( 10 :: int) * integerOfStringHelper ds))" 
  for  ds  :: "(char)list " 
  and  d  :: " char "
|" integerOfStringHelper ([]) = (( 0 :: int))"


definition integerOfString  :: " string \<Rightarrow> int "  where 
     " integerOfString s = ( (case   s of
